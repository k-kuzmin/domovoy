...
labels=(
  ...
  # Круги ревью плана считаются отдельно от кругов ревью диффа: предмет
  # другой, объект другой (задача, а не PR), и общий счётчик смешал бы их.
  'plan-review/1|c5def5|Первый круг ревью плана пройден'
  'plan-review/2|fbca04|Второй круг ревью плана — последний, дальше задача уходит человеку'
)
