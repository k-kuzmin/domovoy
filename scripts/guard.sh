...
#
# Чего проверка не ловит: переименования файла снимка — в базовой ревизии по
# новому пути числа нет, и сравнение промолчит. Приём шумный, rename виден в
# диффе глазами, а второй рубеж — сам инвариант: без снимка по ожидаемому
# пути он краснеет с текстом «сравнить не с чем».
# ------------------------------------------------------------------
